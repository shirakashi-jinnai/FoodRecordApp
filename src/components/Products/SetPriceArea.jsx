...
const SetPriceArea = (props) => {
    ...
    const addPrices = (size, price, index) => {
        ...
        if (props.prices.length === index) {
            props.setPrices(prevState => [...prevState, { size: size, price: price }])
    ...
    return (
        <TableContainer component={Paper} >
            ...
            <div>
                <TextField
                    value={size} onChange={inputSize} label='サイズ'
                    margin='dense' type='text' placeholder='大盛り...etc'
                />
                <TextField
                    value={price} onChange={inputPrice} label='価格'
